goog.provide('org.maths.signals');
 ...
 * @constructor
 * @name org.maths.signals.SignalBinding
 * @param {org.maths.signals.Signal} signal	Reference to Signal object that listener is currently bound to.
 * @param {Function} listener	Handler function bound to the signal.
 * @param {boolean} isOnce	If binding should be executed just once.
 * @param {Object} [listenerContext]	Context on which listener will be executed (object that should represent the `this` variable inside listener function).
 * @param {Number} [priority]	The priority level of the event listener. (default = 0).
 */
org.maths.signals.SignalBinding = function (signal, listener, isOnce, listenerContext, priority) {
     ...
     * @memberOf org.maths.signals.SignalBinding.prototype
     * @name context
...
org.maths.signals.SignalBinding.prototype = {
...
org.maths.signals.validateListener = function(listener, fnName) {
 ...
 * @constructor
 */
org.maths.signals.Signal = function () {
    /**
...
org.maths.signals.Signal.prototype = {
    ...
    add : function (listener, scope, priority) {
        org.maths.signals.validateListener(listener, 'add');
     ...
     * @see org.maths.signals.Signal.prototype.disable
     */
    halt : function () {
