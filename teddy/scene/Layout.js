 ...
 */
goog.provide('teddy.scene.Layout');
...
//goog.require('teddy.model.Context');

goog.require('lime.RoundedRect');

//goog.require('teddy.view.Panel1');
//goog.require('teddy.view.Panel2');
//goog.require('teddy.view.Main');

/**
 * @constructor
 * @extends lime.Scene
 */
teddy.scene.Layout = function() {

    // super
    goog.base(this);

    //this.context = new teddy.model.Context();
...
goog.inherits(teddy.scene.Layout, lime.Scene);
 ...
 * @return {teddy.scene.Layout} this scene
 */
teddy.scene.Layout.prototype.setSize = function(value, opt_height) {
